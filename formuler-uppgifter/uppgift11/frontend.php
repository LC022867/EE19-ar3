        ...
        <form action="backend.php" method="POST">
            ...
            <div class="kol2">
                ...
                <div class="form-check form-switch">
                    ...
                    <label class="form-check-label" for="cf">C&deg; till F&deg;
                    </label>
                </div>
                <div class="form-check form-switch">
                ...
                <div class="form-check form-switch">
                    <input class="form-check-input" type="checkbox" id="ck" name="riktning" value="ck">
                    <label class="form-check-label" for="ck">C&deg; till K&deg;</label>
                </div>
            </div>
